package com.osrsbot.autotrainer.overlay
  ...
  class OverlayManager(private val context: Context) {
      ...
      private val params = WindowManager.LayoutParams(
          ...
          // FLAG_NOT_FOCUSABLE: overlay doesn't steal keyboard focus
          // FLAG_NOT_TOUCH_MODAL: touches OUTSIDE the overlay pass through to OSRS
      ...
      fun show(
          ...
          // Buttons — wired BEFORE drag so touch events are not stolen
      ...
      /**
       * Drag is attached ONLY to the dragHandle view (the grid icon).
       * Buttons in the header are completely unaffected.
       */
